...
package Net::FreshBooks::API::AutoBill;

use Net::FreshBooks::API::AutoBill::Card;
...
has 'card' => (
    is      => 'rw',
    isa     => 'Net::FreshBooks::API::AutoBill::Card',
    default => sub { return Net::FreshBooks::API::AutoBill::Card->new },
);
...
sub _fields {
    return {
        ...
        card         => {
            is           => 'rw',
            made_of      => 'Net::FreshBooks::API::AutoBill::Card',
            presented_as => 'object',
        },
    };
}
...
Returns a Net::FreshBooks::API::AutoBill::Card object
